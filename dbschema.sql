...
create table person(id INT,name varchar(256),gender char(1),PRIMARY KEY(person_id));
create table department(id INT,name varchar(256),credit_id varchar(64),PRIMARY KEY(dept_id));
...
create table genre(id INT,genre_name varchar(256));
create table movie_genre(movie_id INT,genre_id INT);
create table prod_country(id INT,country_name varchar(64));
create table movie_prod_country(prod_country_id INT,movie_id INT);
create table spoken_lang(id INT,language varchar(64));
